              ...
              <form method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="user" class="form-control" placeholder="Enter Username" value="<?php if(isset($user_name)){echo $user_name; } else { echo ""; } ?>" required>
                  </div>
                  <div class="form-group">
                    <label for="password">Password</label>
                    <input type="password" id="pwd" name="pass" class="form-control" id="" placeholder="Enter Password"  value="<?php if(isset($user_pass)){echo $user_pass; } else { echo ""; } ?>" required>
                    
                    <button onclick="show()" type="button" style="float: right;" id="eye">
...
<?php
               ...
               if(isset($_POST['reg'])){
                   ...
                   $sql = "INSERT INTO `tbl_users`(`u_name`, `u_pass`, `role_id`, `u_status`, `date_time`) VALUES ('$username','$password','$role','active', current_timestamp() )";
