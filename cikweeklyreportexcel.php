...
<?php
          ...
          echo '<table id="CIKSheet" class=" table-responsive items rounded table scrollbar scrollbar-primary overflow-auto  table table-striped table-bordered table-sm" cellspacing="0" >
                  <tbody >';
