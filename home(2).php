...
$users_row = mysqli_num_rows($users_query_run);
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $users_row; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
...
<!--
                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-messages" id="msgBody">
                  ...
                  <!-- /.card-body -->
                  <div class="card-footer">
                    <form id="frmrecord" action="#" method="post">
              ...
              <div class="col-md-6">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      <span class="badge badge-danger"><?php echo $users_row; ?> New Members</span>
                      <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        <i class="fas fa-minus"></i>
                      </button>
                      <button type="button" class="btn btn-tool" data-card-widget="remove">
                  ...
                  <div class="card-footer text-center">
                    <a href="add-user.php">View All Users</a>
                  </div>
                  <!-- /.card-footer -->
                </div>
                <!--/.card -->
