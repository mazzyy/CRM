...
where year ='$emp_yrs' and month = '$emp_mont'");
...
var hadd = hdd/2
  ...
  var total = parseInt(aa) + parseInt(lat) + parseInt(hadd) + parseInt(trn) ; 
...
$(".btns").click(function() {
 //$('#ides<?php echo $i;?>').each(function() {
  ...
  var latetotl = (parseInt(late/3))*per;
  var haf_daytotal = (parseInt(haf_day/2))*per;
//alert(parseInt(haf_day/2));
  var traintotal = train*per;




var dectotal = parseFloat(deductions) + parseFloat(cash_Advance);

//alert(parseInt(Penalties));

if(parseInt(Penalties)) 
{
   var deduct = parseFloat(deductions) - parseFloat(Penalties);
    // alert(deductions);
//var deduct = parseFloat(deductions).toFixed(2);
...
var dectotal = parseFloat(deductions).toFixed(2);
...
var addtol = parseFloat(salary) + parseFloat(bonus);
...
var addtotal = parseFloat(addtol) + parseFloat(depend);
}
...
if(parseInt(Arrears)) 
{
    // alert(deductions);
//var deduct = parseFloat(deductions).toFixed(2);
var addtalaq = parseFloat(addtotal) + parseFloat(Arrears);
...
if(parseInt(commission)) 
{
    // alert(deductions);
//var deduct = parseFloat(deductions).toFixed(2);
var addtotal = parseFloat(addtalaq) + parseFloat(commission);
...
//var dectotal = parseFloat(deductions) + parseFloat(cash_Advance);
 ...
 //var addtotal = parseFloat(salary) + parseFloat(bonus) + parseFloat(depend) + parseFloat(commission) + parseFloat(Arrears);
 ...
 html +=' <tr>';
     ...
     html +='<td style="border-top: 1px solid #000000; border-right: 1px solid #000000" colspan="2" align="center" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F">PKR '+absentotal.toFixed(2);+'</font></b> </td>';
     html +='<td align="left" valign="bottom"><font color="#000000"><br></font> </td>';
  html +='</tr>';
  html +='<tr>';
     html +='<td height="20" align="left" valign="bottom"><font color="#000000"><br></font> </td>';
     ...
     html +='<td align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
     html +='<td align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F">Late</font></b> </td>';
     html +='<td align="right" valign="bottom" bgcolor="#F2F2F2" ><b><font color="#3F3F3F">'+late+'</font></b> </td>';
     html +='<td style="border-right: 1px solid #000000" colspan="2" align="center" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F">PKR '+latetotl.toFixed(2);+'</font></b> </td>';
     html +='<td align="left" valign="bottom"><font color="#000000"><br></font> </td>';
...
html +='</tr>  <tr>';
     ...
     html +='<td align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
     html +='<td align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F">Trianing</font></b> </td>';
     html +='<td align="right" valign="bottom" bgcolor="#F2F2F2" ><b><font color="#3F3F3F">'+train+'</font></b> </td>';
     html +='<td style="border-right: 1px solid #000000" colspan="2" align="center" valign="bottom" bgcolor="#F2F2F2" ><b><font color="#3F3F3F">PKR '+traintotal.toFixed(2);+'</font></b> </td>';
     html +='<td align="left" valign="bottom"><font color="#000000"><br></font> </td>';
  html +='</tr>  <tr>';
  ...
  html +='</tr>  <tr>';
     ...
     html +='<td style="border-right: 1px solid #000000" colspan="2" align="center" valign="bottom" bgcolor="#F2F2F2" ><b><font color="#3F3F3F">PKR '+haf_daytotal.toFixed(2);+'</font></b> </td>';
     html +='<td align="left" valign="bottom"><font color="#000000"><br></font> </td>';
  html +='</tr>  <tr>';
     html +='<td height="20" align="left" valign="bottom"><font color="#000000"><br></font> </td>';
     ...
     html +='<td style="border-right: 1px solid #000000" colspan="2" align="center" valign="bottom" bgcolor="#F2F2F2" ><b><font color="#3F3F3F">PKR '+parseFloat(deduct).toFixed(2)+'</font></b> </td>';
     html +='<td align="left" valign="bottom"><font color="#000000"><br></font> </td>';
  html +='</tr>  <tr>';
     html +='<td height="20" align="left" valign="bottom"><font color="#000000"><br></font> </td>';
     html +='<td style="border-left: 1px solid #000000" align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"></font></b> </td>';
     html +='<td align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
     html +='<td align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
     html +='<td colspan="2" align="center" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"></font></b> </td>';
     html +='<td align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
  ...
  html +='</tr>  <tr>';
     ...
     html +='<td align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
     html +='<td align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F">CashAdvance</font></b> </td>';
     html +='<td align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
 ...
 html +=' </tr>  <tr>';
     ...
     html +='<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000" align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
     html +='<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000" colspan="2" align="center" valign="bottom" bgcolor="#F2F2F2"><font color="#3F3F3F">PKR '+parseFloat(addtotal).toFixed(2);+'</font> </td>';
     html +='<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000" align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
     html +='<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000" align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
     html +='<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000" align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
     html +='<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-right: 1px solid #000000" colspan="2" align="center" valign="bottom" bgcolor="#F2F2F2" "><font color="#3F3F3F">PKR '+parseFloat(dectotal).toFixed(2);+'</font> </td>';
     html +='<td align="left" valign="bottom"><font color="#000000"><br></font> </td>';
 html +=' </tr>  <tr>';
     html +='<td height="20" align="left" valign="bottom"><font color="#000000"><br></font> </td>';
     ...
     html +='<td style="border-bottom: 1px solid #000000" align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
     html +='<td style="border-bottom: 1px solid #000000" align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
     html +='<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000" colspan="2" align="center" valign="bottom" bgcolor="#F2F2F2" ><b><font color="#3F3F3F">PKR '+parseFloat(payable).toFixed(2);+'</font></b> </td>';
     html +='<td style="border-bottom: 1px solid #000000" align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
     html +='<td style="border-bottom: 1px solid #000000" align="left" valign="bottom" bgcolor="#F2F2F2"><b><font color="#3F3F3F"><br></font></b> </td>';
 ...
 html +=' </tr>  <tr>';
  ...
  html +='</tr>  <tr>';
     html +='<td height="20" align="left" valign="bottom"><font color="#000000"><br></font> </td>';
     html +='<td colspan="10" align="left" valign="bottom"><i><font color="#000000">RUPEES     : '+parseFloat(payable).toFixed(2);+'</font></i> </td>';
     html +='<td align="left" valign="bottom"><font color="#000000"><br></font> </td>';
  html +='</tr>';
 html +=' <tr>';
     html +='<td height="20" align="left" valign="bottom"><font color="#000000"><br></font> </td>';
...
<div class="row">
  ...
  <!-- /.content-wrapper -->
   ...
   <script type="text/javascript">
    // $(".btns").click(function() {
            //var divContents = document.getElementById("qwert").innerHTML;  
