...
<div class="wrapper" id="myDiv">
  ...
  <div class="content-wrapper">
    ...
    <?php
              ...
              $fetch_user = "SELECT id,name from lead_status WHERE id = '$lest_get_id' ";
              ...
              <form method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="username">lead Status</label>
...
<?php
               ...
               if(isset($_POST['reg'])){
                   ...
                   $sql = "INSERT INTO `lead_status` ( `name`, `date`) VALUES ('$username',current_timestamp() )";
                  ...
                  if (mysqli_query($conn, $sql)) {
                   ...
                   $update_sql = "UPDATE `lead_status` SET `name`='$username' WHERE `u_id` = '". $_GET['proID'] ."' ";
                   
                    if (mysqli_query($conn, $update_sql)) {

                        echo '<script type="text/javascript">
                                swal("", "Lead Status has been Updated Successfully ...", "success");
                                </script>';
        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All lead</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
$users_query = "SELECT `id`, `name`,`date` FROM `lead_status`";      
...
?>
                 <tr>
                   ...
                   <td><?php echo $lest_name; ?></td>
                    ...
                    <td>
                        <a href="leadstatus.php?proID=<?php echo $lest_id; ?>" title="Edit" class="btn btn-primary btn-sm">Edit</a>
                        <a href="leadstatus.php?proID=<?php echo $lest_id; ?>" title="Delete" class="btn btn-danger btn-sm">Delete</a>
