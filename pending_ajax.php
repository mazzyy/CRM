...
<div class="dropdown-divider"></div>
          ...
          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            <i class="fas fa-stopwatch mr-2"></i>'.$u_name.' &'.$satus.'
